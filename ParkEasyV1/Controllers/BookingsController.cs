    ...
    public class BookingsController : Controller
    {
        ...
        public JsonResult CreateBooking([ModelBinder(typeof(JsonNetModelBinder))] CreateBookingRequest _request)
        {
            try
            {
                ...
                _request.DepartureDate1 = _request.DepartureDate1.Date + new TimeSpan(0, 0, 0);
                ...
                //declare instance of usermanager
                UserManager<User> userManager = new UserManager<User>(new UserStore<User>(db));
                User bookingUser = userManager.FindByEmail("john@gmail.com");
                ...
                Booking booking = db.Bookings.Add(new Booking()
                {
                    ...
                    Duration = CalculateBookingDuration(_request.DepartureDate1, _request.ReturnDate),
                    Total = db.Tariffs.Find(1).Amount * Convert.ToInt32(CalculateBookingDuration(_request.DepartureDate1, _request.ReturnDate)),
